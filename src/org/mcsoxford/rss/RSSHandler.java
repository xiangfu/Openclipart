...
//        }
//
//        final String type = MediaAttributes.stringValue(attributes, ENCLOSURE_TYPE);
//        final int length = MediaAttributes.intValue(attributes, ENCLOSURE_LENGTH, DEFAULT_DIMENSION);
...
//
//        item.addThumbnail(new MediaThumbnail(android.net.Uri.parse(url), height, width));
////        item.addEnclosure(new Enclosure(android.net.Uri.parse(url), type, length));
//      }
//
//    };
